...
private
  def text_params
    params.require(:text).permit(:main_up_text, :main_h1_text, 
      ...
      :outsours_h1, :s_voditelem_h1,:main_up_text_en, :main_h1_text_en, 
      :main_quick_booking_text_en, :main_substances_text_en, 
      :main_car_list_text_en, :main_services_text_en, :main_mission_text_en, :main_edge_text_en, 
      :footer_text_en, :prices_text_en, :prices_bottom_text_en, :contacts_text_en, :bookings_bottom_text_en, 
      :reviews_text_en, :terms_text_en, :faqs_text_en, :about_text_en, :main_description_en, :main_title_en, 
      :bookings_title_en, :bookings_description_en, :cars_title_en, 
      :cars_description_en, :car_title_en, :car_description_en, :prices_title_en, 
      :prices_description_en, :contacts_title_en, :contacts_description_en, :reviews_title_en, 
      :reviews_description_en, :terms_title_en, :terms_description_en, :faqs_title_en, :faqs_description_en,
      :abouts_title_en, :abouts_description_en, :services_title_en, :services_description_en, 
      :deliveries_title_en, :deliveries_description_en, :delivery_title_en, :delivery_description_en, 
      :articles_title_en, :articles_description_en, :articles_h1_en, :dop_table_downtext_en, 
      :conditions_en, :success_en, :aeroport_h1_en, :aeroport_title_en, 
      :aeroport_description_en, :aeroport_avto_en, 
      :zelenogradsk_h1_en, :zelenogradsk_title_en, :zelenogradsk_description_en, 
      :zelenogradsk_avto_en, :svetlogorsk_h1_en, :svetlogorsk_title_en, :svetlogorsk_description_en, 
      :svetlogorsk_avto_en, :yantarnyi_h1_en, :yantarnyi_title_en, :yantarnyi_description_en, 
      :yantarnyi_avto_en, :baltyisk_h1_en, :baltyisk_title_en, :baltyisk_description_en, 
      :baltyisk_avto_en, :pionerskyi_h1_en, :pionerskyi_title_en, :pionerskyi_description_en, 
      :pionerskyi_avto_en, :chernyahovsk_h1_en, :chernyahovsk_title_en, :chernyahovsk_description_en, 
      :chernyahovsk_avto_en, :aeroport_text_en, :zelenogradsk_text_en, :svetlogorsk_text_en,
      :yantarnyi_text_en, :baltyisk_text_en, :pionerskyi_text_en, :chernyahovsk_text_en, 
      :s_voditelem_text_en, :s_voditelem_title_en, :s_voditelem_description_en, :car_sharing_text_en, 
      :car_sharing_title_en, :car_sharing_description_en, :casko_text_en, :casko_title_en, 
      :casko_description_en, :corporate_text_en, :corporate_title_en, :corporate_description_en, 
      :sales_text_en, :sales_title_en, :sales_description_en, :payment_text_en, :payment_title_en, 
      :payment_description_en, :outsours_text_en, :outsours_title_en, :outsours_description_en, 
