<template>
  <div id="search_main">
    <loading
      ...
      color="#1976d2"
    ></loading>
    <div class="block2" v-if="locale && locale == 'en'">
      <div class="wrapper">
        <div class="zagol">Pick up and order a car</div>
        <form>
            <div class="obol">
              <flat-pickr v-model="start_date" placeholder="Lease start date" :config="configStart"></flat-pickr>
            ...
            <div class="obol">
                <flat-pickr v-model="end_date" placeholder="Lease end date" :config="configEnd"></flat-pickr>
    ...
    goToCars () {
      if (this.start_date && this.end_date && this.start_time && this.end_time && this.city) {
        if (moment(this.start_date, "DD-MM-YYYY").isSameOrBefore(moment(this.end_date, "DD-MM-YYYY"))) {
          if (this.locale == 'en') {
            window.location.replace(`/en/cars?start_date=${this.start_date}&start_time=${this.start_time}&end_date=${this.end_date}&end_time=${this.end_time}&city=${this.city}`)
          } else {
